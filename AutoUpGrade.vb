...
'                                         vbCrLf & _
'                                         "AutoUpGrade.exe 実行ファイル名 f1 f2 f3" & vbCrLf & _
'                                         vbCrLf & _
...
'                                         "f3" & vbTab & vbTab & "0 ログを追記する(default)    " & vbTab & "1 ログを消去してから記録を行う" & vbCrLf
    ...
    Sub Main()
        ...
        Dim hMutex As New System.Threading.Mutex(False, "is2_AutoUpGrade")
        ...
        'myFolderName = "http://wwwis2.fukutsu.co.jp/is2/Release/"
        myFolderName = "https://wwwis2.fukutsu.co.jp/is2/Release/"
        '// MOD 2005.06.24 東都）伊賀 httpsとhttpの切り替え END
        myFileName = "IS2Client.exe"
    ...
    Private Sub ShowMessage(ByVal addMessage As String)
        Windows.Forms.MessageBox.Show(addMessage, _
                                      "is2", Windows.Forms.MessageBoxButtons.OK, Windows.Forms.MessageBoxIcon.Exclamation)
    End Sub
